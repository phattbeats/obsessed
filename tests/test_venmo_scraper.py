...
def test_user_source_url_strips_at_prefix():
    assert _user_source_url("@jordan-rivera-21") == "https://venmo.com/jordan-rivera-21"


def test_user_source_url_strips_query():
    assert _user_source_url("jordan-rivera-21?tab=code") == "https://venmo.com/jordan-rivera-21"
...
def test_feed_source_url_includes_anchor():
    url = _feed_source_url("jordan-rivera-21")
    assert url == "https://venmo.com/jordan-rivera-21#public-feed"
